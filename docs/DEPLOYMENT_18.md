...
9. Configurar Resend/domínio remetente e testar cadastro, reenvio, reset e entrega sem expor tokens. `EMAIL_PROVIDER=dev-file` é rejeitado em produção.
